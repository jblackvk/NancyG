            ...
            <View style={styles.conteneur}>
                <View style={styles.nancy}>
                    ...
                    <Image source={this.state.image}
                           style={{width: 220, height: 220, marginTop: 20, marginBottom: -100}}/>
                </View>
                <View style={{alignItems: 'center', justifyContent: 'center', flex: 1}}>
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            ...
                            // console.log("state", this.state.load);
                    ...
                    <ActivityIndicator animating={this.state.load} color={Colors.deepOrange600}/>
                </View>
            </View>
        );
    }
